...
model_path="./model/model-0.0005-1605534555-90.9091.ckpt"

class ft_net(nn.Module):

    def __init__(self):
        super(ft_net, self).__init__()
        model_ft = resnet101(pretrained=False,num_classes=2).cpu()
...
model.eval()
img = cv2.imread('SOB_M_DC-14-11031-40-010.png')
